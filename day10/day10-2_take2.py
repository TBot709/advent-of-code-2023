...
# file = open(f"./day{puzzleNumber}/day{puzzleNumber}-2_example-input-1.txt",'r')
# file = open(f"./day{puzzleNumber}/day{puzzleNumber}-2_example-input-1-alt.txt",'r')
# file = open(f"./day{puzzleNumber}/day{puzzleNumber}-2_example-input-1-alt-rotated.txt",'r')
# file = open(f"./day{puzzleNumber}/day{puzzleNumber}-2_example-input-2.txt",'r')
# file = open(f"./day{puzzleNumber}/day{puzzleNumber}-2_example-input-3.txt",'r')
# file = open(f"./day{puzzleNumber}/day{puzzleNumber}-2_example-input-4.txt",'r')
# file = open(f"./day{puzzleNumber}/day{puzzleNumber}-2_example-input-5.txt",'r')
# file = open(f"./day{puzzleNumber}/day{puzzleNumber}-2_example-input-6.txt",'r')
# file = open(f"./day{puzzleNumber}/day{puzzleNumber}-2_example-input-7.txt",'r')
# file = open(f"./day{puzzleNumber}/day{puzzleNumber}-2_example-input-8.txt",'r')
