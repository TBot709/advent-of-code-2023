...
file = open('./day02/day02_input.txt','r')
...
sumOfIdsOfGamesThatArePossible = 0
for gameId, game in gameDict.items():
  isPossible = True
  for reveal in game.reveals:
    if reveal.r > rMax or reveal.g > gMax or reveal.b > bMax:
      isPossible = False
  if isPossible:
    sumOfIdsOfGamesThatArePossible += gameId

print(f"{sumOfIdsOfGamesThatArePossible}")
